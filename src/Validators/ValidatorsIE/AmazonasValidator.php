...
class AmazonasValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual do Amazonas é válida.
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_AM.html
     *
    ...
    {
        // A IE do Amazonas deve ter 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE do Amazonas.
     *
     * Utiliza os 8 primeiros dígitos e os pesos de 9 a 2, em ordem,
     * para calcular o dígito verificador:
     *  - Multiplica cada um dos 8 dígitos pelos respectivos pesos;
     *  - Soma os produtos;

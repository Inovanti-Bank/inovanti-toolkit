...
class CearaValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual do Ceará é válida.
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_CE.html
     *
    ...
    {
        // A IE do Ceará deve ter exatamente 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE do Ceará.
     *
     * Utiliza os 8 primeiros dígitos e os pesos [9,8,7,6,5,4,3,2] para:
     *  - Multiplicar cada dígito pelo peso correspondente;
     *  - Somar os produtos;

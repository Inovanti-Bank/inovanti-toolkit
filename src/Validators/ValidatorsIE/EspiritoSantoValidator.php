...
class EspiritoSantoValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual do Espírito Santo é válida.
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_ES.html
     *
    ...
    {
        // A IE do Espírito Santo deve ter 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE do Espírito Santo.
     *

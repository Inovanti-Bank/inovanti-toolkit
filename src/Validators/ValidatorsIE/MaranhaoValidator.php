...
class MaranhaoValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual do Maranhão é válida.
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_MA.html
     *
    ...
    {
        // A IE do Maranhão deve ter exatamente 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE do Maranhão.
     *

...
class ParaValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual do Pará é válida,
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_PA.html
     *
    ...
    {
        // A IE do Pará deve ter 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE do Pará.
     *

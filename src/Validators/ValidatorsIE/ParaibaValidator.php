...
class ParaibaValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual da Paraíba é válida,
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_PB.html
     *
    ...
    {
        // A IE da Paraíba deve ter 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE da Paraíba.
     *

...
class RioGrandeDoNorteValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual do Rio Grande do Norte é válida,
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_RN.html
     *
    ...
    {
        // A IE do Rio Grande do Norte deve ter 9 dígitos.
        if (strlen($ie) !== 9) {
            return false;
        }
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE do Rio Grande do Norte.
     *

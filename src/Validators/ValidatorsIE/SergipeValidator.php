...
class SergipeValidator implements ValidadorIEInterface
{
    /**
     * Verifica se a Inscrição Estadual de Sergipe é válida.
     * conforme a regra: http://www.sintegra.gov.br/Cad_Estados/cad_SE.html
     *
    ...
    /**
     * Realiza o cálculo do dígito verificador para a IE de Sergipe.
     *
